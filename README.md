...
`Java` `PostgreSQL` `JDBC` `Faker` `Enterprise Architecture`
...
- Engineered **12+ DAX measures** including time intelligence, weighted severity scoring, and Row-Level Security (RLS) for state-based access control
- Built geographic visualizations to identify critical compliance gaps and severity patterns across regions
...
- Implemented PL/SQL stored procedures for bookings, cancellations, and waitlist promotions achieving **100% data accuracy**
- Reduced report generation time by 40% and manual processing time by 45%
...
- Built a Python pipeline for voice tokenization and feature extraction, reducing noise by 30%
- Achieved **F1-score of 0.89 and ROC-AUC of 0.94**, validated with speech therapists

`Python` `GANs` `RNNs` `NLP` `Deep Learning`
...
| Category | Stack |
|---|---|
| **Languages** | Python, Java, SQL, PL/SQL, R, Scala, Bash |
| **ML / AI** | Scikit-learn, TensorFlow, PyTorch, XGBoost, LangChain, RAG, LLMs, Hugging Face |
| **Data Engineering** | Apache Spark, Airflow, Kafka, Informatica, ETL/ELT, dbt, Delta Lake |
| **Databases** | PostgreSQL, Oracle SQL, MySQL, MongoDB, Snowflake, Neo4j, BigQuery, Redshift |
| **Cloud & DevOps** | AWS (S3, Glue, SageMaker, Lambda), Docker, Kubernetes, Terraform, CI/CD |
| **Visualization** | Power BI, Tableau, Plotly, Streamlit, Matplotlib, Seaborn, DAX |
...
- Automated validation workflows achieving **100% accuracy** in incident trend monitoring
